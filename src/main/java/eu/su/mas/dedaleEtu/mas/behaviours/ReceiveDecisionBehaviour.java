...
public class ReceiveDecisionBehaviour extends OneShotBehaviour {
	...
	public ReceiveDecisionBehaviour(final Agent myagent,HashMap<String,String> a_pos,HashMap<String,List<String>> mystench,Date tps) {
		super(myagent);
	...
	public void action() {
		...
		while(msg!=null) {
			System.out. println ( "mytime"+this.myTemps+"-------stench "+this.myStench+this.myAgent.getLocalName()+" receiveodeurbehaviour\n--------" ) ;
			SMPosition smg=null;
			try {
		...
		System.out. println ( "mytime"+this.myTemps+" agentproche "+time.keySet()+"-------stench "+this.myStench+this.myAgent.getLocalName()+" receiveodeurbehaviour\n--------" ) ;
