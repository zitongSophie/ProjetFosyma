...
public class SendEndBehaviour extends SimpleBehaviour{
	...
	public SendEndBehaviour(final Agent myagent,List<String> toContact) {
		super(myagent);
	...
	public void action() {
		...
		msg2.setProtocol("ADD_ME_AS_FINISHED");
		...
		try {
			msg2.setContentObject(new SMEnd(((ExploreCoopAgent) this.myAgent).getFiniExpl()));
		} catch (IOException e) {
